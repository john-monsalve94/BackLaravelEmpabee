...
@section('contenido_colmena')
    <section class="flex flex-col gap-3">
        <h1 class="text-center text-2xl font-semibold">Producción de {{ $colmena->nombre }}</h1>
...
@section('scripts')
    <x-grafica-barras-script :tipo="'Produccion'" :siembra="$siembra" :idGrafico="'grafica_produccion'"></x-grafica-barras-script>
@endsection
