<x-guest-layout class="log">
    ...
    <form class="text-black bg-amber-200" method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="inputpass mt-1 w-full" type="password" name="password" required
        ...
        <div class="flex items-center justify-s mt-4">
